...
setup(
  name = 'Excel_to_PDF_invoicing_26',         #* Your package will have this name
  ...
  author = 'Rohit More',                   # Your name
  author_email = 'morer4851@gmail.com',  # Your email
  url = 'https://github.com/Rohit-more-2003/Python_Package_Invoice_Excel_to_PDF.git',              # Homepage of your library (e.g. GitHub or your website)
